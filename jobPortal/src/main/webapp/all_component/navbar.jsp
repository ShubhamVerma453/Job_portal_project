		...
		<ul class="navbar-nav mr-auto">
			...
			<c:if test="${userobj.role eq 'admin' }">
				<li class="nav-item"><a class="nav-link" href="add_job.jsp">
						<i class="fa-solid fa-circle-plus mr-1"></i>Post Job
				</a></li>
		...
		<form class="form-inline my-2 my-lg-0">
			...
			<c:if test="${userobj.role eq 'admin' }">
				<a href="#" class="btn btn-light mr-1"><i
					class="fa-solid fa-user mr-1"></i>Admin</a>
				<a href="logout" class="btn btn-light">Log Out <i
					class="fa-solid fa-arrow-right-to-bracket mr-1"></i></a>
			</c:if>

			<c:if test="${userobj.role eq 'user' }">
				<a href="#" class="btn btn-light mr-1" data-toggle="modal"
					data-target="#exampleModal"><i class="fa-solid fa-user mr-1"></i>${userobj.name }</a>
				<a href="logout" class="btn btn-light">Log Out <i
					class="fa-solid fa-arrow-right-to-bracket mr-1"></i></a>
			</c:if>
